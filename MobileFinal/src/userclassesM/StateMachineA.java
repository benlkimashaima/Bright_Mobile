...
import generatedM.StateMachineBase;
 ...
 * @author Shai Almog
 */
public class StateMachineA extends StateMachineBase {
    ...
    private static final ATMData[] DATA = new ATMData[] {
       new ATMData("LOCAL", "El Ghazela,Ariana Soghra", "Contact", "70687322", "Tunis", "Bienvenue", 36.89835698712139, 10.189748147476214),
    ...
    public StateMachineA(String resFile) {
        super(resFile);
