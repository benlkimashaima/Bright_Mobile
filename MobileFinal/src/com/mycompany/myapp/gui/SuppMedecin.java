 ...
 * @author User
 */
public class SuppMedecin extends Form{
    
   Form current ;
              private Resources themeee;

    public SuppMedecin(Form p){
                                                themeee = UIManager.initFirstTheme("/themeee");

        setTitle("Supprimer une Medecin");
...
btnsupp.addActionListener(e -> {
    ...
    dlg.showDialog();
       ToastBar.Status status = ToastBar.getInstance().createStatus();
            status.setMessage("Medecin Supprimer ...");
    ...
    //////////////////////////////////////////////////////
        ok.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                {
                    try {
                       Medecin t = new Medecin(Integer.parseInt(tfCin.getText()));
                        if( ServiceMedecin.getInstance().supprimerTask(t))
                            Dialog.show("Success","Medecin Supprimer avec succés !",new Command("OK"));
                        else
