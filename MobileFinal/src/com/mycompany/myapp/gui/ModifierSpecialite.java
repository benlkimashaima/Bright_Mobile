 ...
 * @author User
 */
public class ModifierSpecialite extends Form{
          private Resources themeee;
Form current;
   

    public ModifierSpecialite(Form p){
                                        themeee = UIManager.initFirstTheme("/themeee");

        setTitle("Modifier une Specialite");
   ...
   TextField tfidm = new TextField("","nomSpecialite");
        ...
        Button btnValider = new Button("Modifier Specialite");
    ...
    dlg.add(blueLabel);
    TextArea ta = new TextArea("Vous voulez vraiment Modifier cette Specialite");
...
btnValider.addActionListener(e -> {
  ...
  ToastBar.Status status = ToastBar.getInstance().createStatus();
            status.setMessage(" Specialite Modifier ...");
...
////////////////////////////////////////////////////
       ok.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                if ((tfid.getText().length()==0)||(tfidm.getText().length()==0))
                    Dialog.show("Alert", "Please fill all the fields", new Command("OK"));
                else
                {
                  
                    try {
                        Specialite t = new Specialite(Integer.parseInt(tfid.getText()),tfidm.getText());
